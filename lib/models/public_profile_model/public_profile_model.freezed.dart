...
class _$UserPublicProfileImpl implements _UserPublicProfile {
  ...
  @override
  String toString() {
    return 'UserPublicProfile(displayName: $displayName, email: $email, facebookLink: $facebookLink, firstName: $firstName, hometown: $hometown, instagramLink: $instagramLink, lastName: $lastName, blockedList: $blockedList, followers: $followers, following: $following, topDestinations: $topDestinations, tripsCreated: $tripsCreated, tripsJoined: $tripsJoined, uid: $uid, urlToImage: $urlToImage)';
  }
