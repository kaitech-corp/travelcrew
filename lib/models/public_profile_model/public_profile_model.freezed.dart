...
class _$_UserPublicProfile implements _UserPublicProfile {
  ...
  @override
  String toString() {
    return 'UserPublicProfile(tripsJoined: $tripsJoined, tripsCreated: $tripsCreated, hometown: $hometown, instagramLink: $instagramLink, facebookLink: $facebookLink, topDestinations: $topDestinations, blockedList: $blockedList, displayName: $displayName, email: $email, following: $following, followers: $followers, firstName: $firstName, lastName: $lastName, uid: $uid, urlToImage: $urlToImage)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.tripsJoined, tripsJoined) ||
                other.tripsJoined == tripsJoined) &&
            (identical(other.tripsCreated, tripsCreated) ||
            ...
            const DeepCollectionEquality()
                .equals(other._blockedList, _blockedList) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_blockedList),
      displayName,
      email,
