...
//// Add new activity
Future<void> addNewActivity(ActivityModel model, String documentID) async {
...
Future<void> editActivityModel(
  ...
  try {
    ...
    AdminCloudFunction().logError('Error editing activity:  $e');
  }
}
...
ActivityModel _activityFromSnapshot(DocumentSnapshot<Object?> snapshot) {
  if (snapshot.exists) {
    try {
      ...
      AdminCloudFunction().logError('Error retrieving single activity:  $e');
