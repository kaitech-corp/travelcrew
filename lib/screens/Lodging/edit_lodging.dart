...
class _EditLodgingState extends State<EditLodging> {
  ...
  void initState() {
    ...
    endDateTimestamp.value = widget.lodging.endDateTimestamp!;
    startDateTimestamp.value = widget.lodging.startDateTimestamp!;
    ...
    endTime.value = TimeOfDay.fromDateTime(widget.lodging.startDateTimestamp!);
