...
class SplitDetailsPage extends StatelessWidget{
  ...
  const SplitDetailsPage({Key key, this.splitObject, this.purchasedByUID, this.tripDetails}) : super(key: key);

  @override
  Widget build(BuildContext context) {
      return Scaffold(
        appBar: AppBar(
          title: Text('${splitObject.itemName}',style: Theme.of(context).textTheme.headline5,maxLines: 1,overflow: TextOverflow.ellipsis,),
        ),
        body: StreamBuilder2(
          streams: Tuple2(DatabaseService(itemDocID: splitObject.itemDocID,tripDocID: splitObject.tripDocID).costDataList,DatabaseService().getcrewList(tripDetails.accessUsers),),
