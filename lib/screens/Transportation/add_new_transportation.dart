                ...
                builder: (BuildContext context) => Form(
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            ...
                            if (dropdownValue == 'Carpool')
                              TextFormField(
                                  decoration: const InputDecoration(
                                      labelText: 'Carpool with who?'),
                                  textCapitalization: TextCapitalization.words,
                                  keyboardType: TextInputType.name,
                                  onChanged: (String val) => <void>{
                                        carpoolingWith = val,
                                      }),
                            if (dropdownValue == 'Flying')
                              TextFormField(
                                  decoration: const InputDecoration(
                                      labelText: 'Airline'),
                                  textCapitalization:
                            ...
                            Container(
                              ...
                              child:
                                  Text('Comment', style: titleSmall(context)),
                            ),
                            TextFormField(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            final String message =
                'A new travel method has been added to ${widget.trip.tripName}';
            if (form.validate()) {
              try {
                const String action = 'Saving new transportation data';
                AdminCloudFunction().logEvent(action);
                DetailCloudFunction().addTransportation(
                  mode: dropdownValue,
                ...
                AdminCloudFunction()
                    .logError('Error adding new Transportation item:  $e');
              }

              try {
                final String action =
                    'Sending notifications to access users for $documentId';
                AdminCloudFunction().logEvent(action);
                ...
                AdminCloudFunction().logError(
                    'Error sending notifications for new Transportation item:  $e');
              }
