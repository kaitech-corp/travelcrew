...
import '../../services/functions/cloud_functions/chat_functions.dart';
...
class ChatCard extends StatelessWidget {
  ...
  void _deleteMessage(BuildContext context) {
    ChatCloudFunction()
        .deleteChatMessage(tripDocID: tripDocID, fieldID: message.fieldID);
    navigationService.pop();
  }
  ...
  Widget _buildChatBubble(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: message.uid == userService.currentUserID
            ? Colors.lightBlue[100]
            : Colors.grey[300],
        borderRadius: BorderRadius.circular(15.0),
      ),
      child: Column(
        crossAxisAlignment: message.uid == userService.currentUserID
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              DateTimeRetrieval()
                  .dateTimeToTimeOfDay(message.timestamp ?? DateTime(0)),
