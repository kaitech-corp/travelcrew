        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            enabledBorder: OutlineInputBorder(
              ...
              borderSide: const BorderSide(width: 0.52, color: Color(0xFFD2D5D9)),
            ),
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return UsersWidget(
                            ...
                            memberImages: room.users.map((e) => e.profileImage.toString()).toList(),
                            extraMembers: 4,
                          );
                        },
                      ),
...
class _NotificationsTab extends StatelessWidget {
              ...
              ListView.builder(
                ...
                itemBuilder: (context, j) {
                  ...
                  return ListTile(
                    ...
                    onTap: () {
                      if (n.trip != null) {
                        Get.toNamed(kSpecificTripViewScreenRoute, arguments: n.trip);
                      }
                    },
                  );
                },
  ...
  Widget _notificationImage(UserNotificationModel n) {
    final url = n.notificationType == NotificationType.trip.status
        ? n.trip?.images.first ?? ''
