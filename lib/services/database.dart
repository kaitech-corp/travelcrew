...
class DatabaseService {
  ...
  Future<List<DestinationModel>> getDestinations() async {
    const String url =
        'https://storage.googleapis.com/universal-code-135522.appspot.com/apis/destination_list.json';
...
////Save device token to use in cloud messaging.
  ...
  Future<UserPublicProfile> getUserProfile(String uid) async {
    try {
      ...
      CloudFunction()
          .logError('Error retrieving single user profile:  $e');
...
//// Stream in Cost Details
  List<CostObject> _costObjectDataFromSnapshot(
    ...
    try {
      ...
      CloudFunction()
          .logError('Error in streaming cost details: $e');
      return <CostObject>[];
    }
  }
...
////Stream cost data
  ...
  Future<void> retrieveProfileImage() async {
    final DocumentReference<Object?> ref2 =
        userPublicProfileCollection.doc(uid);
    final DocumentSnapshot<Object?> refSnapshot2 = await ref2.get();

    if (refSnapshot2.exists) {
      urlToImage.value =
          UserPublicProfile.fromDocument(refSnapshot2).urlToImage;
    }
  }
  ...
  Future<void> updateUserPublicProfileData(
    ...
    try {
      ...
      _analyticsService
          .writeError('Error creating Public Profile: $e');
      CloudFunction()
          .logError('Error creating public profile:  $e');
    }
  ...
  Future<void> editPublicProfileData(
    ...
    try {
      ...
      _analyticsService
          .writeError('Error editing Public Profile: $e');
      CloudFunction()
          .logError('Error editing public profile:  $e');
    }
    if (urlToImage != null) {
      String urlForImage;
  ...
  Future<void> addNewTripData(Trip trip, File? urlToImage) async {
    ...
    try {
      ...
      if (trip.ispublic) {
        _analyticsService
            .writeError('Error saving new public trip:  $e');
        CloudFunction()
            .logError('Error saving new public trip:  $e');
      } else {
        _analyticsService
            .writeError('Error saving new private trip:  $e');
        CloudFunction()
            .logError('Error saving new private trip:  $e');
      }
    }
    try {
      ...
      CloudFunction()
          .logError('Error saving member data to new trip:  $e');
    }
  ...
  Future<void> convertTrip(Trip trip) async {
    if (!trip.ispublic) {
      try {
        ...
        CloudFunction().logEvent(action);
        await tripsCollectionUnordered
            .doc(trip.documentId)
            .set(<String, dynamic>{
        ...
        CloudFunction()
            .logError('Error converting to public trip: ' '$e');
        _analyticsService
            .writeError('Error converting to public trip:  ' '$e');
      }
    } else {
      try {
        ...
        _analyticsService
            .writeError('Error converting to private trip:  $e');
        CloudFunction()
            .logError('Error converting to private trip:  $e');
      }
    }
  }
  ...
  Future<void> editTripData(
    ...
    try {
      ...
      CloudFunction().logError(
          'Error updating image after editing trip:  $e');
    }
  }
  ...
  Stream<List<UserPublicProfile>> retrieveFollowList(
    ...
    try {
      ...
      CloudFunction()
          .logError('Error retrieving follow list:  $e');
    }
  }
  ...
  List<Need> _retrieveNeedItems(QuerySnapshot<Object?> snapshot) {
    try {
      ...
      CloudFunction().logError('Error retrieving need list:  $e');
      return <Need>[];
    }
  }
  ...
  Future<List<Bringing>> getItems() async {
    ...
    try {
      ...
      CloudFunction()
          .logError('Error retrieving bringing items docID:  $e');
      return <Bringing>[];
    }
  }
  ...
  Future<Trip> getTrip(String documentID) async {
    ...
    try {
      ...
      CloudFunction()
          .logError('Error retrieving single trip by docID:  $e');
      return defaultTrip;
    }
  }
  ...
  Future<Trip> getPrivateTrip(String documentID) async {
    ...
    try {
      ...
      CloudFunction()
          .logError('Error retrieving single private trip:  $e');
      return defaultTrip;
    }
  }
  ...
  Future<void> addNewLodgingData(String documentID, LodgingData lodging) async {
    ...
    try {
      ...
      CloudFunction()
          .logError('Error adding new lodging data:  $e');
    }
  }
  ...
  Future<void> editLodgingData(
    ...
    try {
      ...
      _analyticsService.writeError('Error editing lodging:  $e');
    }
  }
  ...
  Future<void> addNewActivityData(
    ...
    try {
      ...
      _analyticsService
          .writeError('Error adding new activity:  $e');
    }
  }
  ...
  Future<void> editActivityData(
    ...
    try {
      ...
      _analyticsService.writeError('Error editing activity:  $e');
    }
  }
  ...
  LodgingData _lodgingFromSnapshot(DocumentSnapshot<Object?> snapshot) {
    if (snapshot.exists) {
      try {
        ...
        CloudFunction()
            .logError('Error retrieving lodging list:  $e');
  ...
  ActivityData _activityFromSnapshot(DocumentSnapshot<Object?> snapshot) {
    if (snapshot.exists) {
      try {
        ...
        CloudFunction()
            .logError('Error retrieving single activity:  $e');
  ...
  UserPublicProfile _userPublicProfileSnapshot(
    ...
    try {
      ...
      CloudFunction().logError(
          'Error retrieving specific user public profile:  $e');
      // return UserPublicProfile();
    }
    return defaultProfile;
  }
  ...
  Future<void> addNewChatMessage(String displayName, String message, String uid,
    ...
    try {
      ...
      _analyticsService.writeError('Error writing new chat:  $e');
  ...
  Future<void> clearChatNotifications() async {
    try {
      ...
      CloudFunction()
          .logError('Error clearing chat notifications:  $e');
    }
  }
  ...
  Stream<List<ChatData>>? get chatListNotification {
    try {
      ...
      CloudFunction().logError(
          'Error retrieving chat list notifications:  $e');
      return null;
    }
  }
  ...
  List<TCFeedback> _feedbackSnapshot(QuerySnapshot<Object?> snapshot) {
    final List<TCFeedback> feedback =
        snapshot.docs.map((QueryDocumentSnapshot<Object?> doc) {
      return TCFeedback.fromDocument(doc);
    }).toList();
    feedback.sort(
        (TCFeedback a, TCFeedback b) => b.timestamp.compareTo(a.timestamp));
  ...
  Future<void> deleteDMChatMessage({required ChatData message}) async {
    ...
    try {
      ...
      _analyticsService.writeError('Error deleting new chat:  $e');
      CloudFunction()
          .logError('Error deleting dm chat message:  $e');
    }
  }
  ...
  Future<void> clearDMChatNotifications() async {
    try {
      ...
      CloudFunction()
          .logError('Error clearing dm chat notifications:  $e');
    }
  }
  ...
  Stream<List<ChatData>>? get dmChatList {
    try {
      ...
      CloudFunction()
          .logError('Error retrieving dm chat messages:  $e');
      return null;
    }
  }
  ...
  Stream<List<ChatData>>? get dmChatListNotification {
    ...
    try {
      ...
      CloudFunction()
          .logError('Error retrieving dm chat notifications:  $e');
      return null;
    }
  }
  ...
  /// Get all Suggestions
  List<Suggestions> _suggestionListFromSnapshot(
      QuerySnapshot<Object?> snapshot) {
    return snapshot.docs.map((QueryDocumentSnapshot<Object?> doc) {
      final Map<String, dynamic> data = doc.data()! as Map<String, dynamic>;
      return Suggestions(
